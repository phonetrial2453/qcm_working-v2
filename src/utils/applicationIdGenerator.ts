 ...
 * @param classCode The class code (e.g., "QRAN")
 * @param currentCount The current count of applications for this class
 * @returns A formatted application ID (e.g., "QRAN0001")
 */
 ...
 * @param applicationId The application ID (e.g., "QRAN0001")
 * @returns The class code (e.g., "QRAN")
 */
